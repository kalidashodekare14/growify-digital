...
const CallToAction = () => {
    return (
        <div className="bg bg-cover bg-center bg-no-repeat">
            <div className="2xl:w-350 xl:w-310 lg:w-260 w-full m-auto px-5 lg:px-0 py-20 flex justify-center items-center gap-10 h-100">
                <div className="w-150 space-y-3">
                    <p className="text-white">Why Choose Us</p>
                    <h3 className="text-4xl font-semibold text-white">Recognized As One Of The Leading Company!</h3>
                    <div className="flex items-center gap-5">
                        <div className="text-[#f1f1f1bb]">
                ...
                <div className="bg-white w-140 rounded-3xl p-10  mt-20">
                    <p>Contact Us</p>
